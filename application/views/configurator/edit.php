...
<div class="form-horizontal">
    ...
    <div class="control-group warning">
        ...
        <div class="controls">
            <?php echo form_input('codecanyon_username', set_value('codecanyon_username', 'valid'))?>
        </div>
    </div>
    <div class="control-group warning">
        <label class="control-label" for="codecanyon_code"><?php echo lang_check('codecanyon_code')?></label>
        <div class="controls">
            <?php echo form_input('codecanyon_code', set_value('codecanyon_code', 'valid'))?>
        </div>
    </div>
    <div class="control-group">
        <div class="controls">
            <?php echo form_submit('submit', lang_check('save'), 'class="btn btn-primary"')?><br />
        </div>
    </div>
</div>
<?php echo form_close();?>
