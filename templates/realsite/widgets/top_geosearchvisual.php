...
function hideShow_tags(parent_seletor) {
    ...
    if($('a[data-region="'+parent_seletor+'"]').closest('li').find('ul li').length>6) {
        ...
        $.each(_Liselector, function(key, value){
            if(!$(this).hasClass('active') && !$(this).find('a').hasClass('more-tags') && _count>6){
            ...
            <div class="map-geo-widget">
                ...
                <div id="map-geo">
                    ...
                    <?php else: ?>
                        ...
                        <?php elseif (file_exists(FCPATH . 'files/treefield_64_map.svg')): ?>
