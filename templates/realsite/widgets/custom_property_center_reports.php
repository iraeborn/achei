...
<a class="btn-info popup-with-form-report" style="display:inline-block;margin-left: 5px;" id="report_property" href="#popup_report_property" style=""><i class="icon-flag icon-white" style=""></i> <?php echo lang_check('Report property'); ?> <i class="load-indicator"></i></a>
    <?php endif; ?>    
