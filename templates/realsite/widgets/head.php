...
<script type="text/javascript" src="assets/js/custom_google_marker.js"></script>
                 ...
                 /*console.log(data.results);*/
                    $.each(data.results, function(index, listing) {
                      if( typeof listing.latLng !== 'undefined'){
                            ...
                            var marker_inner ='<img  src="'+listing.options.icon+'" alt="">';
                            var args = {'marker_classes':"marker "+data.results[index].options.cssclass+"-mark-color"};
                            var marker = new CustomMarker(myLatlng,map_main,marker_inner,callback,args);
                            markers.push(marker);          
                      }
                    });
                    
                    map_main.setCenter({lat:data.results_center[0], lng: data.results_center[1]});
