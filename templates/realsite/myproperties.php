        ...
        <div class="row-fluid">
            ...
            <div class="property_content">
                <div class="widget-controls"> 
                    <?php echo anchor('frontend/editproperty/'.$lang_code.'#content', '<i class="icon-plus icon-white"></i>&nbsp;&nbsp;'.lang_check('Addproperty'), 'class="btn btn-info"')?>
                    
                    <?php if(file_exists(APPPATH.'controllers/admin/booking.php')):?>
                        <?php echo anchor('rates/payments/'.$lang_code.'#content', '<i class="icon-book icon-white"></i>&nbsp;&nbsp;'.lang_check('Payments received'), 'class="btn btn-primary pull-right"')?>
...
<?php echo '<i class="icon-shopping-cart icon-white"></i> '.lang('Pay for activation'); ?>
...
<?php elseif($settings_featured_price > 0 && config_db_item('payments_enabled') == 1): ?>                        
    ...
    <?php echo '<i class="icon-shopping-cart icon-white"></i> '.lang_check('Pay for featured'); ?>
    <span class="caret"></span>
    </a>
    <ul class="dropdown-menu">
        <?php if(!_empty(config_db_item('paypal_email'))): ?>
...
<?php endif;?>
                                    	...
                                    	<td><?php echo anchor('frontend/editproperty/'.$lang_code.'/'.$estate->id, '<i class="icon-edit icon-white"></i> '.lang('Edit'), array('class'=>'btn btn-info'))?></td>
                                    	<td><?php echo anchor('frontend/deleteproperty/'.$lang_code.'/'.$estate->id, '<i class="icon-remove icon-white"></i> '.lang('Delete'), array('onclick' => 'return confirm(\''.lang_check('Are you sure?').'\')', 'class'=>'btn btn-danger'))?></td>
                                    </tr>
                        <?php endforeach;?>
                        <?php else:?>
                                    <tr>
...
<?php echo '<i class="icon-shopping-cart icon-white"></i> '.lang('Buy/Extend'); ?>
<span class="caret"></span>
</a>
<ul class="dropdown-menu">
    <?php if(!_empty(config_db_item('paypal_email'))): ?>
